...
public class DefaultSmppServerTest {
    ...
    public DefaultSmppServer createSmppServer() {
        ...
        DefaultSmppServer smppServer = new DefaultSmppServer(configuration, serverHandler, false, 1);
        return smppServer;
    }
    ...
    public void serverNotEnoughWorkerThreadsCausesBindTimerToCloseChannel() throws Exception {
        ...
        DefaultSmppServer server0 = new DefaultSmppServer(configuration, serverHandler0, false, 1);
        server0.start();
