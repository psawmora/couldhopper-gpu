...
public class ClientMain {
    ...
    static public void main(String[] args) throws Exception {
        ...
        try {
            ...
            String text160 =
                    "\u20AC Lorem [ipsum] dolor sit amet, consectetur adipiscing elit. Proin feugiat, leo id commodo tincidunt," +
                            " nibh diam ornare est, vitae accumsan risus lacus sed sem metus.";
            ...
            submit0.setSourceAddress(new Address((byte) 3, (byte) 1, "40404"));
            submit0.setDestAddress(new Address((byte) 0x01, (byte) 0x01, "44555519205"));
            submit0.setShortMessage(textBytes);
            submit0.setServiceType("40404");
            submit0.setShortMessage("TEST MESSAGE".getBytes(Charset.forName("utf-8")));
